...
const { getStoreRequests, acknowledgeStoreRequests, getAgent, addAgent, removeAgent, createWarhouse, paycollateral } = require('../controllers/adminController');
...
router.post('/paycollateral', paycollateral);
